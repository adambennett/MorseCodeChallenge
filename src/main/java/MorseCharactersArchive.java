...
public class MorseCharactersArchive {
    ...
    public Optional<MorseCharacter> getCharacter(ArrayList<MorseNotation> sounds) {
    ...
    static {
        try { instance = new MorseCharactersArchive(); }
        catch (Exception ex) {
            throw new RuntimeException("Failed to statically initialize MorseCharactersArchive!");
        }
    }

    private void initArchive() {
        ArrayList<MorseNotation> dynamicSounds = new ArrayList<>();
        MorseCharacter dynamicChar;

        ArrayList<MorseNotation> dynamicSoundsA = new ArrayList<>();
        dynamicSounds.add(MorseNotation.DIH);
        dynamicSounds.add(MorseNotation.DAH);
